package com.sinndevelopment.reddevil.data;
...
public class YAMLViewerHandler
{
    ...
    public static Viewer getViewer(String name)
    {
        ...
        if(!confDir.exists())
        {
            RedDevil.getLogger().info("Data directory does not exist, creating now.");
            confDir.mkdir();
        }
        ...
        {
            RedDevil.getLogger().info("Userdata file for " + name + " was not found. Creating now with base data.");
